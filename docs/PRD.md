...
- Preset investigator selection for 1-4 investigators.
- Main game screen with scene art, active NPC portrait, narrative feed, action dock, party status, menu, and info drawer.
